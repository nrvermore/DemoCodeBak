...
public class PushExample {
	...
	protected static final String APP_KEY = "7e6acd1f6f689e905ecfb31e";
	// protected static final String MASTER_SECRET = "61807e56ddaebf2e47172159";
	protected static final String MASTER_SECRET = "6dc3414aac0049d398d651d9";
	...
	public static final String REGISTRATION_ID = "1104a897929ef4d8c90";
	...
	public static void testSendPushWithCallback() {
		...
		final NettyHttpClient client = new NettyHttpClient(
				ServiceHelper.getBasicAuthorization(APP_KEY, MASTER_SECRET),
				null, clientConfig);
		try {
	...
	public static void testSendPushIos() {
		ClientConfig clientConfig = ClientConfig.getInstance();
		final JPushClient jpushClient = new JPushClient(MASTER_SECRET, APP_KEY,
				null, clientConfig);
		String authCode = ServiceHelper.getBasicAuthorization(APP_KEY,
		...
		// clientConfig);
		// jpushClient.getPushClient().setHttpClient(httpClient);
		final PushPayload payload = buildPushObject_ios_tagAnd_alertWithExtrasAndMessageIos();
		// // For push, all you need do is to build PushPayload object.
		// PushPayload payload = buildPushObject_all_alias_alert();
		try {
			PushResult result = jpushClient.sendPush(payload);
	...
	public static void testSendGroupPush() {
		GroupPushClient groupPushClient = new GroupPushClient(
				GROUP_MASTER_SECRET, GROUP_PUSH_KEY);
	...
	public static PushPayload buildPushObject_ios_tagAnd_alertWithExtrasAndMessageIos() {
		return PushPayload
				.newBuilder()
				.setPlatform(Platform.ios())
				.setAudience(Audience.tag_and("com.LabWinner"))
				.setNotification(
						Notification
								.newBuilder()
								.addPlatformNotification(
	...
	public static PushPayload buildPushObject_android_cid() {
		return PushPayload.newBuilder().setPlatform(Platform.android())
				...
				.setNotification(Notification.alert(ALERT)).setCid("cid")
				.build();
	}
