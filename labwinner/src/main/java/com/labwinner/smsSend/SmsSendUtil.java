...
public class SmsSendUtil {
    ...
    //智能匹配模板发送接口的http地址
    private  String URI_SEND_SMS = "https://sms.yunpian.com/v2/sms/single_send.json";
    ...
    //绑定主叫、被叫关系的接口http地址
    private  String URI_SEND_BIND = "https://call.yunpian.com/v2/call/bind.json";

    //解绑主叫、被叫关系的接口http地址
    private  String URI_SEND_UNBIND = "https://call.yunpian.com/v2/call/unbind.json";
